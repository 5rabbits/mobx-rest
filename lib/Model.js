...
var dontMergeArrays = function dontMergeArrays(_oldArray, newArray) {
  return newArray;
};
...
var Model = (_class = (_temp = _class2 = function (_Base) {
  ...
  (0, _createClass3.default)(Model, [{
    ...
    value: function fetch() {
      ...
      var data = _ref.data,
          otherOptions = (0, _objectWithoutProperties3.default)(_ref, ['data']);

      var _apiClient$get = (0, _apiClient2.default)().get(this.url(), data, otherOptions),
    ...
    key: 'applyPatchChanges',
    value: function applyPatchChanges(oldAttributes, changes) {
      return (0, _deepmerge2.default)(oldAttributes, changes, {
    ...
    value: function save(attributes) {
      ...
      var _ref2$optimistic = _ref2.optimistic,
          ...
          patch = _ref2$patch === undefined ? false : _ref2$patch,
          _ref2$keepChanges = _ref2.keepChanges,
          keepChanges = _ref2$keepChanges === undefined ? true : _ref2$keepChanges,
          otherOptions = (0, _objectWithoutProperties3.default)(_ref2, ['optimistic', 'patch', 'keepChanges']);
      ...
      if (patch && attributes) {
        ...
        data = (0, _extends3.default)({}, currentAttributes, attributes);
      }
      ...
      if (optimistic && attributes) {
        this.set(patch ? this.applyPatchChanges(currentAttributes, attributes) : attributes);
      }

      var _apiClient$method = (0, _apiClient2.default)()[method](this.url(), data, otherOptions),
          promise = _apiClient$method.promise,
          abort = _apiClient$method.abort;

      promise.then(function (data) {
        var changes = getChangesBetween(currentAttributes, (0, _mobx.toJS)(_this3.attributes));
        ...
        (0, _mobx.runInAction)('save success', function () {
          ...
          if (keepChanges) {
            _this3.set(_this3.applyPatchChanges(data, changes));
          }
        });
    ...
    value: function destroy() {
      ...
      var _ref3$optimistic = _ref3.optimistic,
          optimistic = _ref3$optimistic === undefined ? true : _ref3$optimistic,
          otherOptions = (0, _objectWithoutProperties3.default)(_ref3, ['optimistic']);

      var collections = [].concat((0, _toConsumableArray3.default)(this.collections));
      ...
      if (this.isNew) {
        return new _Request2.default(_promise2.default.resolve());
      }

      var _apiClient$del = (0, _apiClient2.default)().del(this.url(), otherOptions),
    ...
    get: function get() {
      return getChangedAttributesBetween((0, _mobx.toJS)(this.committedAttributes), (0, _mobx.toJS)(this.attributes));
    }
    ...
    key: 'changes',
    get: function get() {
      return getChangesBetween((0, _mobx.toJS)(this.committedAttributes), (0, _mobx.toJS)(this.attributes));
    }
  }]);
  return Model;
...
var getChangedAttributesBetween = function getChangedAttributesBetween(source, target) {
  ...
  return keys.filter(function (key) {
    return !(0, _isEqual3.default)(source[key], target[key]);
  });
};
...
var getChangesBetween = function getChangesBetween(source, target) {
  ...
  getChangedAttributesBetween(source, target).forEach(function (key) {
    changes[key] = (0, _isPlainObject3.default)(source[key]) && (0, _isPlainObject3.default)(target[key]) ? getChangesBetween(source[key], target[key]) : target[key];
  });
