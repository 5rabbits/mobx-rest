  ...
  (0, _createClass3.default)(Model, [{
    ...
    value: function save(attributes) {
      ...
      if (patch && attributes) {
        ...
        data = (0, _deepmerge2.default)(currentAttributes, attributes);
      } else {
      ...
      if (optimistic && attributes) {
        this.set(patch ? (0, _deepmerge2.default)(currentAttributes, attributes) : attributes);
      }
      ...
      promise.then(function (data) {
        ...
        (0, _mobx.runInAction)('save success', function () {
          ...
          if (keepChanges) {
            _this3.set((0, _deepmerge2.default)(data, changes));
          }
        });
