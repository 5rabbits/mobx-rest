...
var Model = (_class = (_temp = _class2 = function (_Base) {
  ...
  (0, _createClass3.default)(Model, [{
    ...
    key: 'mergeAttributes',
    value: function mergeAttributes(oldAttributes, newAttributes) {
      return (0, _deepmerge2.default)(oldAttributes, newAttributes, {
    ...
    value: function save(attributes) {
      ...
      if (optimistic && attributes) {
        this.set(patch ? this.mergeAttributes(currentAttributes, attributes) : attributes);
      }
      ...
      promise.then(function (data) {
        ...
        (0, _mobx.runInAction)('save success', function () {
          ...
          if (keepChanges) {
            _this3.set(_this3.mergeAttributes(data, changes));
          }
        });
