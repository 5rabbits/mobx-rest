...
var Model = (_class = (_temp = _class2 = function (_Base) {
  ...
  (0, _createClass3.default)(Model, [{
    ...
    value: function save() {
      ...
      var _apiClient$method = (0, _apiClient2.default)()[method](this.url(), data),
          promise = _apiClient$method.promise,
          abort = _apiClient$method.abort;

      var request = this.withRequest(['saving', label], promise, abort);
    ...
    value: function destroy() {
      ...
      var request = this.withRequest('destroying', promise, abort);
